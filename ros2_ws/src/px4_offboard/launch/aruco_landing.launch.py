...
def generate_launch_description():
    ...
    dictionary_arg = DeclareLaunchArgument(
        ...
        description='ArUco dictionary (e.g. DICT_4X4_50, DICT_ARUCO_MIP_36h12, DICT_6X6_250)'
    )
    ...
    lander_node = Node(
        ...
        executable='aruco_precision_lander',
        parameters=[{
            'search_frame': 'enu',
            'search_x': 3.0,
            'search_y': 2.0,
